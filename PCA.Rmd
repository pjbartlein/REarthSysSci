...
```{r read boxes1, eval=FALSE, echo=TRUE}
...
```{r read boxes, eval=TRUE, echo=FALSE}
# read a .csv file of Davis's data
boxes_path <- "/Users/bartlein.AD/Projects/ESSD/data/csv_files/"
boxes_name <- "boxes.csv"
boxes_file <- paste(boxes_path, boxes_name, sep="")
boxes <- read.csv(boxes_file) 
str(boxes)
...
- [[Matrix algebra]](https://pjbartlein.github.io/GeogDataAnalysis/topics/matrix.html) 
- - [Derivation of principal components](https://pjbartlein.github.io/GeogDataAnalysis/topics/pca.html) 
...
# read data
datapath <- "/Users/bartlein.AD/Projects/ESSD/data/csv_files/"
...
dname <- "hgt_anm"
```
```{r paths1, eval=TRUE, echo=FALSE}
# load ncdf4 package and set paths
library(ncdf4)
ncpath <- "/Users/bartlein.AD/Projects/ESSD/data/nc_files/"
ncname <- "R20C2_anm19812010_1871-2010_gcm_hgt500.nc" 
ncfname <- paste(ncpath, ncname, sep="")
dname <- "hgt_anm"
```
...
Note that this appraoch will only work if the netCDF file is configured in the standard "CF Conventions" way, i.e. as a `nlon` x `nlat` x `nt` array.

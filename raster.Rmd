...
`cru10min30_tmp.nc`, `cru10min30_bio.nc1`, `[SSTexample.nc`, , `air.mon.anom.nc`, `GFEDv3.1_ltm.nc`,  `sage_veg30.nc`, `treecov.nc`.

Download or copy the files to a "data folder" like `"/Users/bartlein/Projects/ESSD/data/nc_files"`.  The examples also make use of the world-outline shape file (`ne_110m_admin_0_countries.shp`), `/shp_files`.

...
```{r read shapefiles, , results="hide", warnings=FALSE, cache=TRUE}
# read shapefiles
...
```{r write other shapefiles2, messages = FALSE, results="hide", warning=FALSE}
# write out the various shapefiles 
outshape <- na10km_bb
...
```{r shaded relief map, cache = TRUE, echo=TRUE, eval=FALSE, messages=FALSE}

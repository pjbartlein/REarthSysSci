...
[[https://pjbartlein.github.io/REarthSysSci/data/csv/IPCC-RF.csv]](https://pjbartlein.github.io/REarthSysSci/data/csv/IPCC-RF.csv) by right-clicking on the link, and saving to a suitable directory.  Here, the file is assumed to have been dowloaded to the folder `/Users/bartlein/projects/geog490/data/csv_files/`.  (Note that this folder is not necessarly the default working directory of R, which can found using the function `getwd()`)

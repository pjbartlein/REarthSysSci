...
```{r tsggplot2, fig.width=6, fig.height=6, eval=FALSE}
ggplot(data = tmp_df, aes(x=year, y=tmp_ts)) +
  # geom_smooth(method = "lm", size=2, color="pink") +
  geom_smooth(method = "loess", size=0.5, color="purple") +
  geom_line() + 
...
```{r hov1, fig.width=5, fig.height=5, eval=FALSE}
...
```{r h2plot, fig.width=4, fig.height=4, eval=FALSE}
# plot

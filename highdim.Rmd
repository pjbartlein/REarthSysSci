...
The data appear to run from 0 to 360, so rotate the longitudes:
...
lon[1:48] <- lon_temp[49:96]
lon[49:96] <- lon_temp[1:48]
image(tmp_array[,, 1], col = rev(brewer.pal(10,"RdBu")))
```

Even though the data is decadal resolution, it's still a lot of data, and so for this example, the data are downsampled in time to produce century time-step decadal average values.

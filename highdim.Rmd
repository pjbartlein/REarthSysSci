...
```{r read tr21, echo=FALSE, eval=TRUE, results="hide", warning=FALSE, cache=FALSE}
...
```{r tr21 subset, echo=FALSE, cache=FALSE}
...
```{r tr21 cube, echo=FALSE, cache=FALSE}
cubeView(tas2, at=cutpts, col.regions=col, legend = FALSE)
```

Here is a link to the plot on the server, if it fails to display on this page:  [https://pjbartlein.github.io/REarthSysSci/tr21cube.html](https://pjbartlein.github.io/REarthSysSci/tr21cube.html)
[[Back to top]](highdim.html)
